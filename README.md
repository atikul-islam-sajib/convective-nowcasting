...
<table> <tr> <th>Multimodal</th> <th>Radar-only</th> <th>pySTEPS (non-DL)</th> </tr> <tr> <td><img src="artifacts/outputs/multimodal/sample_04_2024-06-30_0045.png" width="100%" alt="Multimodal storm sample comparison"></td> <td><img src="artifacts/outputs/radar/sample_04_2024-06-30_0130.png" width="100%" alt="Radar-only storm sample comparison"></td> <td><img src="artifacts/outputs/non-DL/pysteps_comparison_top_p99_sample04_2024-06-30.png" width="100%" alt="pySTEPS storm sample comparison"></td> </tr> <tr> <td> <img src="artifacts/outputs/multimodal/table51_bar_ets_csi_v2.png" width="100%" alt="Multimodal ETS/CSI bar chart"><br> <img src="artifacts/outputs/multimodal/table51_bar_mae_mse_psnr_ssim_v3.png" width="100%" alt="Multimodal MAE/MSE/PSNR/SSIM bar chart"> </td> <td> <img src="artifacts/outputs/radar/table52_bar_ets_csi_v2.png" width="100%" alt="Radar-only ETS/CSI bar chart"><br> <img src="artifacts/outputs/radar/table52_bar_mae_mse_psnr_ssim_v3.png" width="100%" alt="Radar-only MAE/MSE/PSNR/SSIM bar chart"> </td> <td> <img src="artifacts/outputs/non-DL/pysteps_bar_ets_csi.png" width="100%" alt="pySTEPS ETS/CSI bar chart"><br> <img src="artifacts/outputs/non-DL/pysteps_bar_mae_mse_psnr_ssim.png" width="100%" alt="pySTEPS MAE/MSE/PSNR/SSIM bar chart"> </td> </tr> </table>
