...
from src.models.convlstm.ConvRNN import CLSTM_cell           
...
class MultiHorizonTrainingConfig:
    ...
    checkpoint_dir = 'CHECKPOINTS_CONVLSTM_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    train_viz_dir  = 'TRAINVIS_CONVLSTM_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    val_viz_dir    = 'VALVIZ_CONVLSTM_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
...
class ConvLSTMWrapper(nn.Module):
    def __init__(self, num_channels, num_timesteps=5, n_horizons=2, device='cpu'):
        ...
        encoder_params = build_encoder_params(num_channels)
...
def save_visualizations(model, loader, epoch, transform, cfg,
    ...
    fig.suptitle(
        f"Epoch {epoch:03d}  |  {split_name.upper()} -- Best Storm Samples  [ConvLSTM]",
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- ConvLSTM  [RADAR ONLY]")
    print("="*80)
    ...
    train_dataset = SatelliteRadarPatchDataset(
        ...
        radar_only=True,                                    # ← CHANGED: radar-only mode
    )
    ...
    print(f"\nBuilding Model... [ConvLSTM — RADAR ONLY]")
