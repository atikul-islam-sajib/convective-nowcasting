...
class MultiHorizonTrainingConfig:
    ...
    checkpoint_dir = 'CHECKPOINTS_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    train_viz_dir  = 'TRAINVIS_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    val_viz_dir    = 'VALVIZ_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    ...
    resume_from = "CHECKPOINTS_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR/best_ets.pth"
    ...
    mlflow_experiment   = 'nowcasting_simvp_patch_2015_to_2024_t15_to_t60'
    mlflow_run_name     = 'patch256_2H_simvp_wmae_gradloss_2015_to_2024_t15_to_t60'
...
def mlflow_log_config(cfg, horizons, n_train, n_val, total_params):
    mlflow.log_params({
        ...
        'model_backbone':              'SimVP',
        'hid_S':                       cfg.hid_S,
        'hid_T':                       cfg.hid_T,
        'N_S':                         cfg.N_S,
        'N_T':                         cfg.N_T,
        'incep_ker':                   str(cfg.incep_ker),
        'simvp_groups':                cfg.simvp_groups,
...
def save_visualizations(model, loader, epoch, transform, cfg,
    ...
    fig.suptitle(
        f"Epoch {epoch:03d}  |  {split_name.upper()} -- Best Storm Samples  [SimVP]",
...
def train(model, train_loader, val_loader, cfg, transform,
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- SimVP  [RADAR ONLY]")
    print("="*80)
...
if __name__ == "__main__":
    ...
    print(f"\nBuilding Model... [SimVP — RADAR ONLY]")
    ...
    print(f"   hid_S={cfg.hid_S}  hid_T={cfg.hid_T}  N_S={cfg.N_S}  N_T={cfg.N_T}")
    print(f"   incep_ker={cfg.incep_ker}  groups={cfg.simvp_groups}")
    ...
    model = SimVPWrapper(
        ...
        N_S           = cfg.N_S,
        N_T           = cfg.N_T,
        incep_ker     = cfg.incep_ker,
        groups        = cfg.simvp_groups,
    )
