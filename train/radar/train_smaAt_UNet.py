...
class MultiHorizonTrainingConfig:
    ...
    checkpoint_dir = 'CHECKPOINTS_SMAATUNET_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    train_viz_dir  = 'TRAINVIS_SMAATUNET_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    val_viz_dir    = 'VALVIZ_SMAATUNET_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR'
    ...
    resume_from = "CHECKPOINTS_SMAATUNET_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_RADAR/best_ets.pth"

    smaat_kernels_per_layer = 2
    smaat_bilinear          = True
    smaat_reduction_ratio   = 16

    mlflow_experiment   = 'nowcasting_smaatunet_patch_2015_to_2024_t15_to_t60'
    mlflow_run_name     = 'patch256_2H_smaatunet_wmae_gradloss_2015_to_2024_t15_to_t60'
...
def train(model, train_loader, val_loader, cfg, transform,
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- SmaAt-UNet  [RADAR ONLY]")
    print("="*80)
...
if __name__ == "__main__":
    ...
    print(f"\nBuilding Model... [SmaAt-UNet — RADAR ONLY]")
