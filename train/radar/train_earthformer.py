...
def train(model, train_loader, val_loader, cfg, transform,
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- EarthFormer  [RADAR ONLY]")
    print("="*80)
...
if __name__ == "__main__":
    ...
    assert model_cfg['input_shape'] == [n_timesteps, 256, 256, n_channels_per_step], (
        ...
        f"  FIX: In config/earthformer_nowcast.yaml change:\n"
        f"    input_shape: [{n_timesteps}, 256, 256, 3]\n"
        f"  to:\n"
        f"    input_shape: [{n_timesteps}, 256, 256, 1]\n"
        f"{'!'*70}\n"
    )
    ...
    print(f"\nBuilding Model... [EarthFormer / CuboidTransformer — RADAR ONLY]")
