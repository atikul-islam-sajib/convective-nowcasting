...
class MultiHorizonTrainingConfig:
    ...
    checkpoint_dir = 'CHECKPOINTS_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_PRE_FINAL'
    train_viz_dir  = 'TRAINVIS_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_PRE_FINAL'
    val_viz_dir    = 'VALVIZ_SIMVP_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_PRE_FINAL'
    ...
    mlflow_experiment   = 'nowcasting_simvp_patch_2015_to_2024_t15_to_t60_PRE_FINAL'
    mlflow_run_name     = 'patch256_2H_simvp_wmae_gradloss_2015_to_2024_t15_to_t60_PRE_FINAL'
...
def train(model, train_loader, val_loader, cfg, transform,
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- SimVP  [2H: t+15, t+30]")
    print("="*80)
