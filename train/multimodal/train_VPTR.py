...
class MultiHorizonTrainingConfig:
    ...
    resume_from = "CHECKPOINTS_VPTR_PATCH_1KM_SUMMER_2H_2015_to_2024_t15_to_t60_PRE_FINAL/best_ets.pth"

    mlflow_experiment   = 'nowcasting_vptr_patch_2015_to_2024_t15_to_t60_PRE_FINAL'
    mlflow_run_name     = 'patch256_2H_vptr_wmae_gradloss_2015_to_2024_t15_to_t60_PRE_FINAL'
...
def train(model, train_loader, val_loader, cfg, transform,
    ...
    print("\n" + "="*80)
    print("MULTI-HORIZON TRAINING -- VPTR  [4H: t+15, t+30, t+45, t+60]")
    print("="*80)
...
if __name__ == "__main__":
    ...
    print(f"  GPUs          : {torch.cuda.device_count()}x V100-32GB")
    ...
    print(f"   channels/step:    {n_channels_per_step}  (CH7 + CH9 + radar)")
